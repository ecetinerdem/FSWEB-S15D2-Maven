...
public class StringSet {
    ...
    public static Set<String> findUniqueWords() {
        // İlgili text
        String originalText = "Carroll began writing the manuscript of the story the next day, although that earliest version is lost. " +
        ...
        // TreeSet kullanarak otomatik sıralama ve unique özelliği elde ediyoruz
        Set<String> uniqueWords = new TreeSet<>();

        // Kelimeleri TreeSet'e ekle
        for (String word : words) {
            // Boş stringleri ekleme
